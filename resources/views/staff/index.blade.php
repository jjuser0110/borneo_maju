...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light">{{ __('sidebar.staff') }}</span>
        </h4>
        ...
        <div class="card">
            <div class="card-header flex-column flex-md-row">
                <div class="head-label">
                    <h5 class="card-title mb-0">{{ __('sidebar.staff_listing') }}</h5>
                </div>
                ...
                <table class="dt-column-search table table-bordered" id="mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('staff.edit', $row) }}" onclick="showLoading()">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <a style="color:red;cursor:pointer"
                                   onclick="if(confirm('{{ __('sidebar.confirm_delete') }}')){showLoading();window.location.href='{{ route('staff.destroy',$row) }}'}">
