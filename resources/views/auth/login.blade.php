...
<html
  ...
  <head>
    ...
    <title>Borneo Maju System</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('smalllogo.png') }}" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{route('home')}}" class="app-brand-link gap-2">
                  <img src="{{ asset('logo.gif') }}" alt="Logo" style="width:80%; display:block; margin:0 auto;" />
                </a>
              </div>
              <!-- /Logo -->
