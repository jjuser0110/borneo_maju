...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">{{ __('sidebar.dashboard') }}</span> 
    </h4>
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">{{ __('sidebar.orders_count') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">{{ __('sidebar.idr_amount') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-danger h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">{{ __('sidebar.myr_amount') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4">
            <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                    ...
                    <p class="mb-1">{{ __('sidebar.processing_fees') }}</p>
                </div>
            </div>
        </div>
