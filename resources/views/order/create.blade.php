            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" enctype="multipart/form-data" 
                        ...
                        @csrf
                        <div class="col-md-6">
                            <label class="form-label">{{ __('sidebar.order_no') }}</label>
                            <input
                                type="text"
                                class="form-control"
                                name="order_no"
                        ...
                        <div class="col-md-6">
                            <label class="form-label">{{ __('sidebar.order_date') }}</label>
                            <input
                                type="date"
                                class="form-control"
                                name="order_datetime"
                        ...
                        <div class="col-md-4">
                            <label class="form-label">{{ __('sidebar.account_no') }}</label>
                            <input
                                type="text"
                                class="form-control"
                        ...
                        <div class="col-md-4">
                            <label class="form-label">{{ __('sidebar.fullname') }}</label>
                            <input
                                type="text"
                                class="form-control"
                        ...
                        <div class="col-md-3">
                            <label class="form-label">{{ __('sidebar.processing_fees') }}</label>
                            <input
                                type="number"
                                class="form-control"
